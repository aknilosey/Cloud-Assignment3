...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://fl8inowho4.execute-api.us-east-1.amazonaws.com/aakhriDinwala';
    ...
    apigClient.uploadFilenamePut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['filename', 'Access-Control-Allow-Origin', 'Content-Type', 'Access-Control-Allow-Headers', 'Access-Control-Allow-Methods'], ['body']);
